...
public interface EnnMonitorAlarmConfigEmailDeleteResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:EnnMonitorAlarmConfigEmailDeleteResponse)
