...
public interface EnnMonitorAlarmConfigEmailUpdateResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:EnnMonitorAlarmConfigEmailUpdateResponse)
