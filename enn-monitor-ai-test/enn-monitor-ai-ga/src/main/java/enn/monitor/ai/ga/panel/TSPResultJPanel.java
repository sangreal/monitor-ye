...
public class TSPResultJPanel extends JPanel {
	...
	public TSPResultJPanel(int labelWidth, int textWidth) {
	...
	public void setTSPResult(TSPResult tspResult) {
		generationText.setText("" + tspResult.getGeneration());
		resultText.setText("" + tspResult.getResult());
		shortestRouteText.setText("" + tspResult.getShortestRoute());
		longestRouteText.setText("" + tspResult.getLongestRoute());
		totalFeeText.setText("" + tspResult.getTotalFee());
	}
