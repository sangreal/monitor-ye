package enn.monitor.config.business.parameters;
...
public class Parameters {
    ...
    public String mongoUrl = "mongodb://127.0.0.1:27017/EnnMonitorConfigBusiness";
    ...
    public String dbName = "EnnMonitorConfigBusiness";
