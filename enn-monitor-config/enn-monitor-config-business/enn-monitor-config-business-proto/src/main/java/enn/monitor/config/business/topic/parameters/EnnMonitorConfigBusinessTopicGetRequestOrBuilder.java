...
public interface EnnMonitorConfigBusinessTopicGetRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:EnnMonitorConfigBusinessTopicGetRequest)
