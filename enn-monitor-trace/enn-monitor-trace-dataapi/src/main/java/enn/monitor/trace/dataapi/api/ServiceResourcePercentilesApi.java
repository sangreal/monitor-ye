...
import enn.monitor.trace.proto.response.ServiceResourcePercentilesResponse;
 ...
 */
public class ServiceResourcePercentilesApi extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<ServiceResourcePercentiles> links =
                Service.getServiceResourcePercentiles(start, end, bizLine, service, resource);
        ServiceResourcePercentilesResponse respBody = new ServiceResourcePercentilesResponse(
