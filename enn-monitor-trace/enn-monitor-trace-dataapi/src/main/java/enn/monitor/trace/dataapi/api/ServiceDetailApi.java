...
import enn.monitor.trace.proto.response.ServiceDetailResponse;
 ...
 */
public class ServiceDetailApi extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<ServiceDetail> serviceDetailList = Service.getServiceDetail(start, end, calleeBiz, calleeSvc);
        ServiceDetailResponse respBody = new ServiceDetailResponse(
                new ListData<>(serviceDetailList, serviceDetailList.size(), 0, 0),
                "success",
                ""
        );
