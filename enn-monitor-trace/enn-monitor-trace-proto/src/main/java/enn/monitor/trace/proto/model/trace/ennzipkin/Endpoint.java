...
import enn.monitor.trace.proto.model.trace.ennzipkin.internal.InetAddresses;
...
import enn.monitor.trace.proto.model.trace.ennzipkin.internal.Util;
...
public final class Endpoint implements Serializable { // for Spark jobs
     ...
     */
    @Deprecated
    public static Endpoint create(String serviceName, String ipv4, int port) {
        return new Endpoint(serviceName, ipv4, null, port == 0 ? null : (short) (port & 0xffff));
    }

    public static Endpoint create(String serviceName, String ipv4) {
    ...
    Endpoint(String serviceName, String ipv4, @Nullable byte[] ipv6, @Nullable Short port) {
    ...
    public static final class Builder {
        ...
        /**
         * Returns true if {@link #ipv4(String)} or {@link #ipv6(byte[])} could be parsed from the input.
         *
...
//                ipv4(ByteBuffer.wrap(addressBytes).getInt());
         ...
         * Embedded IPv6 Address</a>. In such case, {@link #ipv4(String)} is called with the embedded
         * address.
         *
         * @see Endpoint#ipv6
         */
...
//                    this.ipv4 = ipv4;
    ...
    public enn.monitor.trace.proto.model.trace.ennzipkin2.Endpoint toV2() {
        enn.monitor.trace.proto.model.trace.ennzipkin2.Endpoint.Builder result = enn.monitor.trace.proto.model.trace.ennzipkin2.Endpoint.newBuilder()
