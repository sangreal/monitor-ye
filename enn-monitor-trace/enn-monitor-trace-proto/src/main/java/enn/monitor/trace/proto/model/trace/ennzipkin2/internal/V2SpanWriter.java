 ...
 * the License.
 */
package enn.monitor.trace.proto.model.trace.ennzipkin2.internal;

import enn.monitor.trace.proto.model.trace.ennzipkin2.Annotation;
...
public final class V2SpanWriter implements Buffer.Writer<Span> {
  @Override public int sizeInBytes(Span value) {
    ...
    if (value.resource() != null) {
      sizeInBytes += 10; // ,"name":""
      sizeInBytes += jsonEscapedSizeInBytes(value.resource());
    }
  ...
  @Override public void write(Span value, Buffer b) {
    ...
    if (value.resource() != null) {
      b.writeAscii(",\"name\":\"").writeUtf8(jsonEscape(value.resource())).writeByte('"');
    }
    if (value.timestampAsLong() != 0L) {
