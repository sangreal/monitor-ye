...
public final class V2SpanReader implements JsonCodec.JsonReaderAdapter<Span> {
  ...
  @Override public Span fromJson(JsonCodec.JsonReader reader) throws IOException {
    if (builder == null) {
  ...
  static final JsonCodec.JsonReaderAdapter<Endpoint> ENDPOINT_READER = new JsonCodec.JsonReaderAdapter<Endpoint>() {
    @Override public Endpoint fromJson(JsonCodec.JsonReader reader) throws IOException {
