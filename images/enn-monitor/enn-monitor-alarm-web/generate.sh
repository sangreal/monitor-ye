...
# monitor-security-token-web
filePath=$1/enn-monitor-alarm-web-rc.yml
cp enn-monitor-alarm-web-rc.yml $filePath
...
filePath=$1/enn-monitor-alarm-web-svc.yml
cp enn-monitor-alarm-web-svc.yml $filePath
sed -i -e "s/%NAMESPACE%/$1/g" $filePath
