...
filePath=$1/enn-monitor-alarm-config-server-rc.yml
cp enn-monitor-alarm-config-server-rc.yml $filePath
sed -i -e "s/%NAMESPACE%/$1/g" $filePath
sed -i -e "s/%REPLICSNUM%/$NUM/g" $filePath
sed -i -e "s/%CONFIGLISTENPORT%/$LISTENPORT/g" $filePath
...
filePath=$1/enn-monitor-alarm-config-server-svc.yml
cp enn-monitor-alarm-config-server-svc.yml $filePath
sed -i -e "s/%NAMESPACE%/$1/g" $filePath
sed -i -e "s/%CONFIGLISTENPORT%/$LISTENPORT/g" $filePath
