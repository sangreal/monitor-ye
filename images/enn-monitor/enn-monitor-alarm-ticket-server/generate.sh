...
filePath=$1/enn-monitor-alarm-ticket-server-rc.yml
cp enn-monitor-alarm-ticket-server-rc.yml $filePath
...
filePath=$1/enn-monitor-alarm-ticket-server-svc.yml
cp enn-monitor-alarm-ticket-server-svc.yml $filePath
sed -i -e "s/%NAMESPACE%/$1/g" $filePath
sed -i -e "s/%TICKETLISTENPORT%/$LISTENPORT/g" $filePath
