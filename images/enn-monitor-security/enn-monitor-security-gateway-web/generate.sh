...
filePath=$1/enn-monitor-security-gateway-web-rc.yml
cp enn-monitor-security-gateway-web-rc.yml $filePath
...
filePath=$1/enn-monitor-security-gateway-web-svc.yml
cp enn-monitor-security-gateway-web-svc.yml $filePath
sed -i -e "s/%NAMESPACE%/$1/g" $filePath
sed -i -e "s/%ENNMONITORSECURITYGATEWAYLISTENPORT%/$LISTENPORT/g" $filePath
