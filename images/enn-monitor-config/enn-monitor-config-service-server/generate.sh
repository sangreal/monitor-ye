...
# enn-monitor-config-service-server
filePath=$1/enn-monitor-config-service-server-rc.yml
cp enn-monitor-config-service-server-rc.yml $filePath
...
filePath=$1/enn-monitor-config-service-server-svc.yml
cp enn-monitor-config-service-server-svc.yml $filePath
sed -i -e "s/%NAMESPACE%/$1/g" $filePath
sed -i -e "s/%LISTENPORT%/$LISTENPORT/g" $filePath
