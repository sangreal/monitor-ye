...
filePath=$1/enn-monitor-config-business-web-rc.yml
cp enn-monitor-config-business-web-rc.yml $filePath
...
filePath=$1/enn-monitor-config-business-web-svc.yml
cp enn-monitor-config-business-web-svc.yml $filePath
sed -i -e "s/%NAMESPACE%/$1/g" $filePath
