...
public interface EnnMonitorLogConfigEventUpdateResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:EnnMonitorLogConfigEventUpdateResponse)
