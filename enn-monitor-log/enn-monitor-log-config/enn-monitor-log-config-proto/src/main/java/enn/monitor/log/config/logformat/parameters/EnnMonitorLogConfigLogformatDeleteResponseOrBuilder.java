...
public interface EnnMonitorLogConfigLogformatDeleteResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:EnnMonitorLogConfigLogformatDeleteResponse)
