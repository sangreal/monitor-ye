...
public interface EnnMonitorLogConfigTemplateCreateResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:EnnMonitorLogConfigTemplateCreateResponse)
