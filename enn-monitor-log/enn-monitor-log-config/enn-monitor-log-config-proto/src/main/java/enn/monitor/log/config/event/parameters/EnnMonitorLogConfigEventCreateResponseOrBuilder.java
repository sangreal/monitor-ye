...
public interface EnnMonitorLogConfigEventCreateResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:EnnMonitorLogConfigEventCreateResponse)
