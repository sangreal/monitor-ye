...
public interface EnnMonitorLogConfigLogformatCreateResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:EnnMonitorLogConfigLogformatCreateResponse)
