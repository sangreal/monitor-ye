...
public interface EnnMonitorLogConfigTemplateDeleteResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:EnnMonitorLogConfigTemplateDeleteResponse)
