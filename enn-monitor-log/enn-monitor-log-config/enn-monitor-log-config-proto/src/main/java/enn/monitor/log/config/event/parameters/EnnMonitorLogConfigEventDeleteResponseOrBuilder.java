...
public interface EnnMonitorLogConfigEventDeleteResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:EnnMonitorLogConfigEventDeleteResponse)
