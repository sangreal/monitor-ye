...
public interface EnnMonitorLogConfigAnalyseTermUpdateResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:EnnMonitorLogConfigAnalyseTermUpdateResponse)
